 ...
 * @author Dhwani
 */
public class PastasAndNoodles extends javax.swing.JFrame {
 public static String dppath = "E:/Night_Fury/Sem 4/JAVA/OnlineGroceryShopping/java.accdb";
    ...
    public PastasAndNoodles() {
        initComponents();
        this.setExtendedState(JFrame.MAXIMIZED_BOTH);
        try {
            Connection con = DriverManager.getConnection("jdbc:ucanaccess://" + dppath);
            Statement st = con.createStatement();
            String str = "Select * from Item_Purchase WHERE Category_Id = 13";
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Pasta And Noodles");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(230, 150, 420, 60);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/onlinegroceryshopping/pasta copy.jpg"))); // NOI18N
        jLabel1.setText("jLabel1");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(-4, -1, 900, 300);
        ...
        jButton1.setBounds(110, 550, 70, 70);
        ...
        jButton2.setBounds(370, 550, 70, 70);
        ...
        jButton3.setBounds(620, 550, 70, 70);

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));
        getContentPane().add(jPanel1);
        jPanel1.setBounds(0, 300, 880, 330);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PastasAndNoodles.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
