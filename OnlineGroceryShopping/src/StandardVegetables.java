 ...
 * @author Dhwani
 */
public class StandardVegetables extends javax.swing.JFrame {
    ...
    public StandardVegetables() {
        initComponents();
        this.setExtendedState(JFrame.MAXIMIZED_BOTH);
        try {
            Connection con = DriverManager.getConnection("jdbc:ucanaccess://" + dppath);
            Statement st = con.createStatement();
            String str = "Select * from Item_Purchase WHERE Category_Id = 1";
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(130, 650, 70, 60);
        ...
        jButton2.setBounds(370, 650, 70, 60);
        ...
        jButton3.setBounds(650, 650, 70, 60);

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));
        getContentPane().add(jPanel1);
        jPanel1.setBounds(0, 200, 1050, 530);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StandardVegetables.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
