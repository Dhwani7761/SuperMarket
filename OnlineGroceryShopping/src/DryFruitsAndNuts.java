 ...
 * @author LENOVO
 */
public class DryFruitsAndNuts extends javax.swing.JFrame {
    ...
    /**
     * Creates new form DryFruitsAndNuts
     */
    private ArrayList<String> ar = new ArrayList<String>();
    
    public DryFruitsAndNuts() {
        initComponents();
        this.setExtendedState(JFrame.MAXIMIZED_BOTH);
        try {
            Connection con = DriverManager.getConnection("jdbc:ucanaccess://" + dppath);
            Statement st = con.createStatement();
            String str = "Select * from Item_Purchase WHERE Category_Id = 9";
            ...
            while (rs.next()) {
                ...
                itemCheckbox.setBounds(180, (i * 50) + 300, 300, 180);
                ...
                itemLabel.setBounds(180, (i * 50) + 300, 300, 180);
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(120, 550, 70, 70);
        ...
        jButton2.setBounds(380, 550, 70, 70);
        ...
        jButton3.setBounds(610, 540, 70, 70);

        jLabel3.setFont(new java.awt.Font("Comic Sans MS", 0, 36)); // NOI18N
        jLabel3.setText("Dryfruit and Nuts");
        getContentPane().add(jLabel3);
        jLabel3.setBounds(250, 20, 310, 110);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/onlinegroceryshopping/dryfrts.jpg"))); // NOI18N
        getContentPane().add(jLabel1);
        jLabel1.setBounds(0, 0, 810, 190);

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));
        getContentPane().add(jPanel1);
        jPanel1.setBounds(0, 190, 810, 450);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DryFruitsAndNuts.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
