 ...
 * @author LENOVO
 */
public class OilAndGhee extends javax.swing.JFrame {
 public static String dppath = "E:/Night_Fury/Sem 4/JAVA/OnlineGroceryShopping/java.accdb";
    ...
    public OilAndGhee() {
        ...
        try {
            ...
            String str = "Select * from Item_Purchase WHERE Category_Id = 7";
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Oil and Ghee");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(280, 110, 290, 80);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/onlinegroceryshopping/oil copy.jpg"))); // NOI18N
        jLabel1.setText("jLabel1");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(0, 0, 980, 270);
        ...
        jButton1.setBounds(130, 600, 70, 70);
        ...
        jButton2.setBounds(360, 600, 70, 70);
        ...
        jButton3.setBounds(650, 600, 70, 70);

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));
        getContentPane().add(jPanel1);
        jPanel1.setBounds(0, 270, 980, 410);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OilAndGhee.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
