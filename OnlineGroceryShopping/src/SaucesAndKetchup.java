 ...
 * @author Dhwani
 */
public class SaucesAndKetchup extends javax.swing.JFrame {
    ...
    public SaucesAndKetchup() {
        initComponents();
        this.setExtendedState(JFrame.MAXIMIZED_BOTH);
        try {
            Connection con = DriverManager.getConnection("jdbc:ucanaccess://" + dppath);
            Statement st = con.createStatement();
            String str = "Select * from Item_Purchase WHERE Category_Id = 12";
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Sauces and Ketchup");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(240, 60, 470, 90);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/onlinegroceryshopping/sauces copy.jpg"))); // NOI18N
        getContentPane().add(jLabel1);
        jLabel1.setBounds(4, 4, 990, 190);
        ...
        jButton1.setBounds(130, 440, 70, 70);
        ...
        jButton2.setBounds(420, 440, 70, 70);
        ...
        jButton3.setBounds(630, 440, 70, 70);

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));
        getContentPane().add(jPanel1);
        jPanel1.setBounds(0, 190, 960, 330);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SaucesAndKetchup.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
